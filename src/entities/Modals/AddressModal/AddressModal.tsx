...
import { BaseDialog, BaseImage } from '@/shared/components';
import { IBaseDialogProps } from '@/shared/types';

export const AddressModal = ({ isOpen, onClose }: Pick<IBaseDialogProps, 'isOpen' | 'onClose'>) => (
  <BaseDialog
    closable
    maxWidth="xs"
    footer={null}
    isOpen={isOpen}
    onClose={onClose}
    titleIntl={{ label: 'titles.pickupAddress' }}
  >
    <Grid container>
